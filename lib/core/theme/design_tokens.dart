...
abstract final class DrdSizes {
  ...
  ///
  /// كان رقماً حرفياً داخل `StatusChip`. نُقل إلى هنا لأنه ليس تفصيلاً
  /// داخلياً: الرقاقة تضربه في `textScaler` لتكبر الأيقونة مع النص، وأي
  /// تعديل له يغيّر السطر الذي يبدأ عنده الفيض.
  static const double chipIcon = 14;
