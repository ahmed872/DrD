...
class _LoginScreenState extends State<LoginScreen> {
  ...
  void _handleAuth() async {
    ...
    //
    // الحد الأدنى 8 وليس 6: التطبيق يحمي بيانات طبية، و6 محارف قابلة
    // للتخمين بسرعة. الشرط يسري على الحسابات الجديدة فقط — الحسابات
    // القائمة تدخل بكلمات مرورها الحالية دون تعطيل.
