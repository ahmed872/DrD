...
replacements = {
    ...
    'Ù‚Ù„Ø¨': 'قلب',
    'Ù†ÙØ³ÙŠØ©': 'نفسية',
    'Ø§Ù„Ø¨ØØ« Ø¹Ù† Ø·Ø¨ÙŠØ¨': 'البحث عن طبيب',
    'Ø·Ø¨ÙŠØ¨ ØºÙŠØ± Ù…Ø¹Ø±ÙˆÙ': 'طبيب غير معروف',
    'Ø¹ÙŠØ§Ø¯Ø©': 'عيادة',
    'Ø§Ù„Ù‚Ø§Ù‡Ø±Ø©': 'القاهرة',
    'Ù…Ù† 9:00 Ø¥Ù„Ù‰ 5:00': 'من 9:00 إلى 5:00',
    'Ø·Ø¨ÙŠØ¨ Ù…ØªØ®ØµØµ': 'طبيب متخصص',
    'Ù…ØªØ§Ø Ø§Ù„Ø¢Ù†': 'متاح الآن',
    ...
    'Ø§Ù„ØªØ®ØµØµ': 'التخصص',
    'Ø§Ù„ÙÙ„Ø§ØªØ± Ø§Ù„Ù…ØªÙ‚Ø¯Ù…Ø©': 'الفلاتر المتقدمة',
    'Ø§Ù„ØØ¯ Ø§Ù„Ø£Ø¯Ù†Ù‰ Ù„Ù„ØªÙ‚ÙŠÙŠÙ…': 'الحد الأدنى للتقييم',
    'âÙ‚Ø·': 'فقط',
    'Ø¬Ø§Ø±ÙŠ ØªØÙ…ÙŠÙ„ Ø§Ù„Ø£Ø·Ø¨Ø§Ø¡...': 'جاري تحميل الأطباء...',
    'Ø®ÙŠØ§Ø±Ø§Øª Ø¥Ø¶Ø§ÙÙŠØ©': 'خيارات إضافية',
    'Ù…ØªØ§Ø Ø§Ù„ÙŠÙˆÙ…': 'متاح اليوم',
}
